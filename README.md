...
FruiTell adalah aplikasi mobile berbasis Flutter yang digunakan untuk mendeteksi tingkat kematangan buah menggunakan teknologi Artificial Intelligence (AI).
...
Install Sofware:
- Flutter SDK
- Python 3.11 (Wajib menggunakan Python 3.11 di atau jika di mac gunakan python3 / pip3, karena TensorFlow dan YOLO belum stabil di Python 3.14.). 
